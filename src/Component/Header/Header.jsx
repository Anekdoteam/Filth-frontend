...
import log_s from './Forms/LoginForm.module.css';
...
class Header extends React.Component {
  ...
  render = () => {
    ...
    const profileButton = this.state.isLoggedIn ?
      <img onClick={() => {
          ...
          <Modal.Dialog>
            ...
            <Modal.Body className={s.content}>
              ...
              {this.state.isLoggedIn ? null :
                <div className={`${log_s.main_form_item} ${log_s.reg_row}`}>
                  Не зарегистрированы? <button className={log_s.registration} onClick={this.handleShowRegistration}>Регистрация</button>
                </div>}
            </Modal.Body>
